...
app.scripts.append_script({
    'external_url': 'https://unpkg.com/cytoscape-cose-bilkent@3.6.0/cytoscape-cose-bilkent.js'
})
...
app.layout = html.Div(
    children=[
        ...
        cyto.Cytoscape(
            ...
            mouseoverNodeData=mouseover_node_data,
            elements=elements,
            layout={'name': 'cose-bilkent'},
            external_scripts=['https://unpkg.com/cytoscape-cose-bilkent@3.6.0/cytoscape-cose-bilkent.js'],
            stylesheet=[
                {
                    'selector': 'node',
                    'style': {
...
def display_hover_data(hover_data):
    return html.P(f'Node ID: {hover_data["id"]}\nNode Label: {hover_data["label"]}', style={'font-size': '14px'})
